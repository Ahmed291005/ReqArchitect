...
Analyze the conversation history provided. Based on the user's latest message, update the list of requirements. The user might be providing an initial idea, answering one of your questions, or giving feedback to add, remove, or modify requirements.

After updating the requirements, your primary task is to formulate a single, insightful, open-ended follow-up question that will encourage the user to provide more details about a specific aspect of the application.

- If this is the start of the conversation, generate a few initial requirements and ask a broad question to get started.
...
Return a valid JSON object containing the complete, updated list of requirements and your next follow-up question.
